...
- **Production** : https://openhoat.github.io/cv/
- **Version française** : https://openhoat.github.io/cv/fr/
- **Version anglaise** : https://openhoat.github.io/cv/en/

## 📄 PDFs

Les versions PDF du CV doivent être placées dans le dossier `public/pdf/` :
